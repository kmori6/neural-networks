...
from neural_networks.utils.tokenizer import Tokenizer, train_tokenizer
...
def test_tokenizer(mock_file: Path, tmp_path: Path):
    # train
    train_tokenizer(
        text_file_path=str(mock_file),
        vocab_size=16,
        model_type="unigram",
    ...
    # tokenize
    tokenizer = Tokenizer(str(model_file))
